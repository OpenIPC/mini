...
void isp_version() {
    ...
    printf("    version: ");
    switch (version) {
        case 1: printf("V100"); break;
        case 2: printf("V200"); break;
        case 3: printf("V300"); break;
        case 4: printf("V400"); break;
        case 5: printf("V500"); break;
        case 6: printf("V600"); break;
        case 7: printf("V700"); break;
        default:
    ...
    printf("    build: ");
    switch (build) {
        case 1: printf("BO1"); break;
        case 2: printf("BO2"); break;
        case 3: printf("BO3"); break;
        case 4: printf("BO4"); break;
        case 5: printf("BO5"); break;
        case 6: printf("BO6"); break;
        case 7: printf("BO7"); break;
        default:
